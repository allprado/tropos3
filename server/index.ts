...
// Middleware para SPA - servir index.html para rotas que não são API nem arquivos
app.use((req, res, next) => {
  // Se é uma rota da API, continuar para as rotas específicas
  if (req.path.startsWith('/api')) {
    return next();
  }
  
  // Se é um arquivo (tem extensão), continuar
...
app.get('/api/simulation/:id/download/:filename', (req, res) => {
...
// TODO: Adicionar rota catch-all para SPA após resolver problema do path-to-regexp
// app.get('*', (req, res) => {
//   res.sendFile(path.join(__dirname, '../dist/index.html'));
// });
